                ...
                Row {
                    IconButton(onClick = onGeminiClick) {
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.search_gemini),
                            tint = MaterialTheme.colorScheme.onSurface,
                            modifier = Modifier.size(22.dp),
                        )
                    }
                    IconButton(onClick = onLensClick) {
                        Icon(
                            painter = painterResource(id = R.drawable.google_lens_icon),
                            contentDescription = stringResource(R.string.search_lens),
                            tint = MaterialTheme.colorScheme.onSurface,
                            modifier = Modifier.size(22.dp),
                        )
                    }
